  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          opacity: 0, // Set to 1 to keep it fully visible
        }}
      />
    </motion.div>
  );
...
const OverlayCopy = ({
  ...
  return (
    ...
    >
      <p className="mb-2 text-center  text-3xl p-10">
        {subheading}
      </p>
      <p className="text-center sm: text-5xl md:text-7xl font-bold">{heading}</p>
    </motion.div>
  );
};
